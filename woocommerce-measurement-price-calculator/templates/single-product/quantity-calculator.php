...
$actual_amount_text = apply_filters(
	...
	$product_measurement->get_unit_label() ?
		sprintf( __( 'Actual %s (%s)', WC_Measurement_Price_Calculator::TEXT_DOMAIN ), __( $product_measurement->get_label(), WC_Measurement_Price_Calculator::TEXT_DOMAIN ), __( $product_measurement->get_unit_label(), WC_Measurement_Price_Calculator::TEXT_DOMAIN ) ) :
		sprintf( __( 'Actual %s', WC_Measurement_Price_Calculator::TEXT_DOMAIN ), __( $product_measurement->get_label(), WC_Measurement_Price_Calculator::TEXT_DOMAIN ) )
);
