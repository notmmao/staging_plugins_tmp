...
SV_WC_Framework_Bootstrap::instance()->register_plugin( '4.0.0', __( 'WooCommerce Measurement Price Calculator', 'woocommerce-measurement-price-calculator' ), __FILE__, 'init_woocommerce_measurement_price_calculator', array( 'minimum_wc_version' => '2.2.5', 'backwards_compatible' => '4.0.0' ) );
