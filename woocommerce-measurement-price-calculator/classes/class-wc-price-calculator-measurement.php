...
class WC_Price_Calculator_Measurement {
	...
	public function get_unit_label() {
		 ...
		 *
		 * @since 3.0.1
		 * @param int $label The measurement unit frontend label.
		 * @param object $measurement WC_Price_Calculator_Measurement class instance.
		 */
	...
	public function get_label() {
		 ...
		 *
		 * @since 3.4.0
		 * @param int $label The measurement frontend label.
		 * @param object $measurement WC_Price_Calculator_Measurement class instance.
		 */
