...
class WC_Gateway_Authorize_Net_CIM_eCheck extends WC_Gateway_Authorize_Net_CIM {
	...
	public function __construct() {
		...
		parent::__construct(
			...
			array(
				'method_title'       => __( 'Authorize.net CIM eCheck', WC_Authorize_Net_CIM::TEXT_DOMAIN ),
				'method_description' => __( 'Allow customers to securely pay using their checking/savings accounts with Authorize.net CIM.', WC_Authorize_Net_CIM::TEXT_DOMAIN ),
				'supports'           => array(
