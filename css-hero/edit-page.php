...
<html id="cssherohtml">
    <head>
		  ...
		  <script type='text/javascript' src='//www.csshero.org/production/js/jquery/jquery.js?ver=1.10.2'></script>
    ...
    <body id="csshero-workarea">
		  ...
		  function wpcss_initialize_editor_data()
							  {          
									 jQuery( "body" ).data( "wpcss_current_settings_array", '<?php echo addslashes(json_encode(unserialize(get_option('wpcss_current_settings_array_'.wpcss_current_theme_slug()))));  ?>' ).data( "wpcss_admin_url", '<?php echo get_admin_url(); ?>' ).data( "wpcss_site_url", '<?php echo get_bloginfo('url'); ?>' );
								  } 
					  
		  </script>
		<script type='text/javascript' src='//csshero.org/production/heroes-loader-2016.php?<?php echo $ademo ?>version=<?php echo $csshero_version .$rocket_mode_string ?>&key=<?php echo  wpcss_check_license() ?>&theme=<?php echo $theme_slug ?>&plugins=<?php echo wpcss_active_site_plugins() ?>'></script> 
		  ...
		  <script type='text/javascript' src='//www.csshero.org/production/js/jquery.form.min.js'></script>
		  <script type='text/javascript' src='//www.csshero.org/production/js/jquery/ui/jquery.ui.core.min.js'></script>
		  <script type='text/javascript' src='//www.csshero.org/production/js/jquery/ui/jquery.ui.widget.min.js'></script>
		  <script type='text/javascript' src='//www.csshero.org/production/js/jquery/ui/jquery.ui.mouse.min.js'></script>
		  <script type='text/javascript' src='//www.csshero.org/production/js/jquery/ui/jquery.ui.draggable.min.js'></script>
		  <script type='text/javascript' src='//www.csshero.org/production/js/jquery/ui/jquery.ui.resizable.min.js'></script>
		  <script type='text/javascript' src='//www.csshero.org/production/js/jquery/ui/jquery.ui.slider.min.js'></script>
		  <script type='text/javascript' src='//www.csshero.org/production/js/jquery/jquery.ui.touch-punch.js'></script>
		  <script type='text/javascript' src='//www.csshero.org/production/js/jquery/ui/jquery.ui.button.min.js'></script>
		  <script type='text/javascript' src='//www.csshero.org/production/js/jquery/ui/jquery.ui.dialog.min.js'></script>
		  <script type='text/javascript' src='//www.csshero.org/production/js/iris.min.js'></script>
    </body>
</html>
