...
class WAS_Match_Conditions {
	...
	public function __construct() {
		...
		add_filter( 'was_match_condition_subtotal', array( $this, 'was_match_condition_subtotal' ), 10, 3 );
		add_filter( 'was_match_condition_subtotal_ex_tax', array( $this, 'was_match_condition_subtotal_ex_tax' ), 10, 3 );
		add_filter( 'was_match_condition_tax', array( $this, 'was_match_condition_tax' ), 10, 3 );
		add_filter( 'was_match_condition_quantity', array( $this, 'was_match_condition_quantity' ), 10, 3 );
		add_filter( 'was_match_condition_contains_product', array( $this, 'was_match_condition_contains_product' ), 10, 3 );
		add_filter( 'was_match_condition_coupon', array( $this, 'was_match_condition_coupon' ), 10, 3 );
		add_filter( 'was_match_condition_weight', array( $this, 'was_match_condition_weight' ), 10, 3 );
		add_filter( 'was_match_condition_contains_shipping_class', array( $this, 'was_match_condition_contains_shipping_class' ), 10, 3 );

		add_filter( 'was_match_condition_zipcode', array( $this, 'was_match_condition_zipcode' ), 10, 3 );
		add_filter( 'was_match_condition_city', array( $this, 'was_match_condition_city' ), 10, 3 );
		add_filter( 'was_match_condition_state', array( $this, 'was_match_condition_state' ), 10, 3 );
		add_filter( 'was_match_condition_country', array( $this, 'was_match_condition_country' ), 10, 3 );
		add_filter( 'was_match_condition_role', array( $this, 'was_match_condition_role' ), 10, 3 );

		add_filter( 'was_match_condition_width', array( $this, 'was_match_condition_width' ), 10, 3 );
		add_filter( 'was_match_condition_height', array( $this, 'was_match_condition_height' ), 10, 3 );
		add_filter( 'was_match_condition_length', array( $this, 'was_match_condition_length' ), 10, 3 );
		add_filter( 'was_match_condition_stock', array( $this, 'was_match_condition_stock' ), 10, 3 );
		add_filter( 'was_match_condition_stock_status', array( $this, 'was_match_condition_stock_status' ), 10, 3 );
		add_filter( 'was_match_condition_category', array( $this, 'was_match_condition_category' ), 10, 3 );
	 ...
	 */
	public function was_match_condition_subtotal( $match, $operator, $value ) {
	 ...
	 * @return 	BOOL 				Matching result, TRUE if results match, otherwise FALSE.
	 */
	public function was_match_condition_subtotal_ex_tax( $match, $operator, $value ) {
	 ...
	 * @return 	BOOL 				Matching result, TRUE if results match, otherwise FALSE.
	 */
	public function was_match_condition_tax( $match, $operator, $value ) {
	 ...
	 * @return 	BOOL 				Matching result, TRUE if results match, otherwise FALSE.
	 */
	public function was_match_condition_quantity( $match, $operator, $value ) {
	 ...
	 * @return 	BOOL 				Matching result, TRUE if results match, otherwise FALSE.
	 */
	public function was_match_condition_contains_product( $match, $operator, $value ) {
	 ...
	 * @return 	BOOL 				Matching result, TRUE if results match, otherwise FALSE.
	 */
	public function was_match_condition_coupon( $match, $operator, $value ) {
	 ...
	 * @return 	BOOL 				Matching result, TRUE if results match, otherwise FALSE.
	 */
	public function was_match_condition_weight( $match, $operator, $value ) {
	 ...
	 * @return 	BOOL 				Matching result, TRUE if results match, otherwise FALSE.
	 */
	public function was_match_condition_contains_shipping_class( $match, $operator, $value ) {
 ...
 *****************************************************/
	 ...
	 * @return 	BOOL 				Matching result, TRUE if results match, otherwise FALSE.
	 */
	public function was_match_condition_zipcode( $match, $operator, $value ) {
		...
		if ( '==' == $operator ) :
			...
			if ( preg_match( '/\, ?/', $value ) ) :
				$match = ( in_array( (double) WC()->customer->get_shipping_postcode(), array_map( 'doubleval', explode( ',', $value ) ) ) );
			else :
				$match = ( (double) WC()->customer->get_shipping_postcode() == (double) $value );
			endif;
	 ...
	 * @return 	BOOL 				Matching result, TRUE if results match, otherwise FALSE.
	 */
	public function was_match_condition_city( $match, $operator, $value ) {
	 ...
	 * @return 	BOOL 				Matching result, TRUE if results match, otherwise FALSE.
	 */
	public function was_match_condition_state( $match, $operator, $value ) {
	 ...
	 * @return 	BOOL 				Matching result, TRUE if results match, otherwise FALSE.
	 */
	public function was_match_condition_country( $match, $operator, $value ) {
	 ...
	 * @return 	BOOL 				Matching result, TRUE if results match, otherwise FALSE.
	 */
	public function was_match_condition_role( $match, $operator, $value ) {
 ...
 *****************************************************/
	 ...
	 * @return 	BOOL 				Matching result, TRUE if results match, otherwise FALSE.
	 */
	public function was_match_condition_width( $match, $operator, $value ) {
	 ...
	 * @return 	BOOL 				Matching result, TRUE if results match, otherwise FALSE.
	 */
	public function was_match_condition_height( $match, $operator, $value ) {
	 ...
	 * @return 	BOOL 				Matching result, TRUE if results match, otherwise FALSE.
	 */
	public function was_match_condition_length( $match, $operator, $value ) {
	 ...
	 * @return 	BOOL 				Matching result, TRUE if results match, otherwise FALSE.
	 */
	public function was_match_condition_stock( $match, $operator, $value ) {
	 ...
	 * @return 	BOOL 				Matching result, TRUE if results match, otherwise FALSE.
	 */
	public function was_match_condition_stock_status( $match, $operator, $value ) {
	 ...
	 * @return 	BOOL 				Matching result, TRUE if results match, otherwise FALSE.
	 */
	public function was_match_condition_category( $match, $operator, $value ) {
