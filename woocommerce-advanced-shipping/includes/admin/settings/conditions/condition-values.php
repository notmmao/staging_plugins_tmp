	...
	?><span class='was-value-wrap was-value-wrap-<?php echo $id; ?>'><?php
		...
		switch ( $values['field'] ) :
			...
			case 'text' :
				...
				?><input type='text' class='was-value' name='_was_shipping_method_conditions[<?php echo $group; ?>][<?php echo $id; ?>][value]'
			...
			case 'select' :
				...
				?><select class='was-value' name='_was_shipping_method_conditions[<?php echo $group; ?>][<?php echo $id; ?>][value]'><?php
