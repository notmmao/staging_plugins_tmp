...
function was_condition_conditions( $id, $group = 0, $current_value = 'subtotal' ) {
	...
	<span class='was-condition-wrap was-condition-wrap-<?php echo $id; ?>'>

		<select class='was-condition' data-group='<?php echo $group; ?>' data-id='<?php echo $id; ?>'
			name='_was_shipping_method_conditions[<?php echo $group; ?>][<?php echo $id; ?>][condition]'>

			<?php foreach ( $conditions as $option_group => $values ) :
