...
?><div class='was was_settings was_meta_box was_settings_meta_box'>
	...
	<p class='was-option'>
		...
		<input type='text' class='' id='shipping_title' name='_was_shipping_method[shipping_title]' style='width: 190px;'
			value='<?php echo @$settings['shipping_title']; ?>' placeholder='<?php _e( 'e.g. Shipping', 'woocommerce-advanced-shipping' ); ?>'>
	...
	<p class='was-option'>
		...
		<input type='number' step='any' class='' id='cost' name='_was_shipping_method[shipping_cost]'
			value='<?php echo @$settings['shipping_cost']; ?>' placeholder='<?php _e( 'Shipping cost', 'woocommerce-advanced-shipping' ); ?>'>
	...
	<p class='was-option'>
		...
		<span class='was-currency'><?php echo get_woocommerce_currency_symbol(); ?></span>
		<input type='text' class='wc_input_decimal' id='handling_fee' name='_was_shipping_method[handling_fee]'
			value='<?php echo @$settings['handling_fee']; ?>' placeholder='<?php _e( 'Fixed or percentage', 'woocommerce-advanced-shipping' ); ?>'>
	...
	<p class='was-option'>
		...
		<span class='was-currency'><?php echo get_woocommerce_currency_symbol(); ?></span>
		<input type='text' class='' id='price' name='_was_shipping_method[cost_per_item]'
			value='<?php echo @$settings['cost_per_item']; ?>' placeholder='<?php _e( 'Fixed or percentage', 'woocommerce-advanced-shipping' ); ?>'>
	...
	<p class='was-option'>
		...
		<span class='was-currency'><?php echo get_woocommerce_currency_symbol(); ?></span>
		<input type='text' class='' id='price' name='_was_shipping_method[cost_per_weight]'
			value='<?php echo @$settings['cost_per_weight']; ?>' placeholder='<?php _e( '0', 'woocommerce-advanced-shipping' ); ?>'>
